...
public class DVDTitlesController : Controller
{
    ...
    public DVDTitlesController(IDVDTitlesService service, ApplicationDbContext context, IConfiguration configuration)
    {
        _service = service;
        _context = context;
    ...
    public async Task<IActionResult> Create()
    {
        ...
        {
            connection.Open();
            var dvdtitle = connection.Query<DVDTitle>("adddvdnew", commandType: CommandType.StoredProcedure).ToList();
            return dvdtitle;
        }*/
        ...
        var data = from dvdtitle in _context.DVDTitles
            ...
            select new
            {
                ...
                Cast = from casts in dvdtitle.CastMembers
                    ...
                    group actor by new {casts.DVDNumber}
                    into g
                    select
                        string.Join(", ",
