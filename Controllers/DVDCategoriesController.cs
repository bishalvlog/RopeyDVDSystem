...
public class DVDCategoriesController : Controller
{
    ...
    public async Task<IActionResult> Create(
        [Bind("CategoryName, CategoryDescription, AgeRestricted")] DVDCategory dVDCategory)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Edit(int id,
        [Bind("CategoryNumber, CategoryName, CategoryDescription, AgeRestricted")] DVDCategory dVDCategory)
    {
